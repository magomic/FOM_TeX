%-------------------------------------------------------------------------------------------------
% Template Version 1.0.4							27.02.2015									(c) Erhan Tuna
% 1.0.1		einfache Ergänzungen und Korrekturen (begin{Citation}, etc.), FOM Anpassungen am Titelblatt
% 1.0.2		\Zitat{}
% 1.0.3		minipage im Environment graybox
% 1.0.4		Schriftarten eingefügt
% Achtung! in der Datei dinat.bst wurde die Fkt. push.ua von "u.\,a." in "et~al." geändert ! - kein Versionsinkrement nötig - 
% 1.0.5		\dcite für direkte Zitate ohne "Vgl."
%-------------------------------------------------------------------------------------------------
...
% WENN Inhaltsverzeichnis, Abkürzungsverzeichnis, Abbildungsverzeichnis, Tabellenverzeichnis AM Dokumentenanfang stehen sollen DANN
 \usepackage[abbreviation,toctotoc]{fomdss} % optionen: toctotoc (TOC ins TOC aufnehmen), nopagebreak (Seitenumbruch nach Verzeichnissen), abbreviation (Abkürzungsverzeichnis), abbrevrefpage(Ref zur Seite)
%-------------------------------------------------------------------------------------------------
% WENN Inhaltsverzeichnis, Abkürzungsverzeichnis, Abbildungsverzeichnis, Tabellenverzeichnis AM Dokumentenende stehen sollen DANN
...
%-------------------------------------------------------------------------------------------------
% WENN Absätze, Zitate (besondere) DANN
...
% \usepackage{fomfod}
%-------------------------------------------------------------------------------------------------
% Das Paket fomidx steckt in der Dokumentenklasse (Ausnahme!) da es den Regeln von LaTeX geschuldet ist, gehört aber zum Paket Dokumentenende
%-------------------------------------------------------------------------------------------------
\usepackage{xstring} % für macro \fcite bzw. \dcite um letztes Zeichen zu extrahieren 
%-------------------------------------------------------------------------------------------------
% SCHRIFTARTEN------------------------------------------------------------------------------------
%\usepackage{bookman}
 %\usepackage{lmodern}
...
%-------------------------------------------------------------------------------------------------
	...
	\Institute{Hochschule für\\ Ökonomie \& Management Essen \\ \large Standort Frankfurt am Main} 	% Name der Hochschule
	...
	%\LockflagContent[]{fom} % fom steht für Standard-FOM-Formulierung; sig für Ort, Datum, Unterschrift
	%-------------------------------------------------------------------------------------------------
	% WENN documentclass:affidavit
	\AffidavitContent[sig]{std} % std ist die Standard-Formulierung
	%-------------------------------------------------------------------------------------------------
...
%-VERZEICHNISSE-------------------------------------------------------------------------------------
\PrintContents % TOC
\PrintAbbrev	% Abkürzungsverzeichnis
\PrintFigures	% Abbildungsverzeichnis
\PrintTables	% Tabellenverzeichnis
%---------------------------------------------------------------------------------------------------
...
%\newcommand{\Zitat}{1} % Diese Version geht aus Compilertechnischen Gründen nicht, siehe ftp://ftp.ams.org/pub/tex/amslatex/math/technote.pdf (Punkt 6) und http://www.golatex.de/wiki/%5Cdef
%{
	%\begin{Citation}[\parskip]{12mm}{15mm}
	%\textit{\glqq #1 \grqq}
	%\end{Citation}
%}
\newcommand{\Zitat}[2] % keine Verwendung von fcite in 2. Argument möglich, kein Anhängen von fcite an das Zitat möglich (neue zeile)
...
%----------------------------------------------------------------------------------------------------
% Für Hervorhebungen, Zitate und Kästen(?) mit Text, siehe folgende Makros
%\Remark[Einzug][Abstand]{\bf label}{text}	% linksbündiges label
%\Item[Einzug][Abstand]{\bf label}{text}	% rechtsbündiges label
%\begin{Citation}[soll optional, ist aber pflicht]{pflicht}{pflicht} % Abstand links und rechts; Case-sensitive
%\end{Citation}
% fompar:\Description für Überschriften, die nicht ins TOC sollen (keine Verwendung von sub/paragraph)
%----------------------------------------------------------------------------------------------------
%-----------------------------------------------------------
...
\PrintBibliography{Literatur} % Literaturverzeichnis{Dateiname ohne Endung}
